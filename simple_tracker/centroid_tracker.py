...
class CentroidTracker:
	def __init__(self, maxDisappeared=50, maxDistance=30):
		...
		self.labels_lists = OrderedDict()
		self.labels = OrderedDict()

		self.disappeared = OrderedDict()

		# Number of frames a dissappeared objects can exist before deregistering
		self.maxDisappeared = maxDisappeared

		# Distance to mark an object as "disappeared"
	...
	def register(self, centroid, box, label):
		...
		self.addLabel(label,self.nextObjectID)
	...
	def deregister(self, objectID):
		...
		del self.labels_lists[objectID]
	...
	def update(self, rects, labels):
		...
		# centroids
			...
			for (row, col) in zip(rows, cols):
				...
				self.addLabel( labels[col], objectID )
